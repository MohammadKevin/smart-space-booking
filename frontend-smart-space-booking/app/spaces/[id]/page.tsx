        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-5">
          ...
          <div className="flex items-center gap-2.5 self-start sm:self-auto">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-5 py-2 bg-sky-600 hover:bg-sky-500 active:bg-sky-700 text-white text-xs font-bold rounded-xl shadow-sm shadow-sky-600/25 transition-all cursor-pointer"
            >
          ...
          <div className="lg:col-span-8 space-y-6">
            <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
              <div className="relative aspect-[16/9] w-full bg-slate-100 overflow-hidden">
                ...
                />
                <span className="absolute top-3 left-3 bg-slate-900/80 backdrop-blur-xs text-white font-mono text-[10px] px-3 py-1 rounded-lg font-bold uppercase">
              ...
              <div className="p-6 space-y-5">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-3 border-t border-slate-100 text-xs">
                  <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200">
                    ...
                    <strong className="text-slate-900 text-sm">{space.kapasitas} Orang</strong>
                  </div>
                  <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200">
                    <span className="text-[10px] text-slate-400 font-mono uppercase block">Tarif Sewa</span>
                    <strong className="text-sky-600 font-mono text-sm">{formatRupiah(space.hargaPerJam)} / jam</strong>
                  </div>
                  <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200">
                    <span className="text-[10px] text-slate-400 font-mono uppercase block">Tipe Ruangan</span>
                    <strong className="text-slate-900 uppercase font-mono text-sm">{space.tipe?.replace(/_/g, " ")}</strong>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm space-y-4">
              ...
              <div className="space-y-3">
                {reviews.length > 0 ? (
                  reviews.map((r) => (
                    <div key={r.id} className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-1.5 text-xs">
          ...
          <div className="lg:col-span-4 space-y-4 lg:sticky lg:top-20">
            <div className="bg-white rounded-2xl border border-slate-200 p-6 space-y-4 shadow-sm">
              ...
              <div className="space-y-3 text-xs">
                ...
                <Link
                  href={`/booking/${space.id}`}
                  className="w-full py-3 px-4 rounded-xl bg-sky-600 hover:bg-sky-500 active:bg-sky-700 text-white text-xs font-bold transition-all shadow-sm shadow-sky-600/25 flex items-center justify-center gap-2 cursor-pointer mt-3"
                >
