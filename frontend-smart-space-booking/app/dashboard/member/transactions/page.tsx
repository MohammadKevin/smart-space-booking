  ...
  return (
    <div className="space-y-6 pb-16">
      ...
      <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col lg:flex-row items-center justify-between gap-3">
        <div className="flex items-center gap-1.5 p-1 bg-slate-100 rounded-xl w-full lg:w-auto overflow-x-auto text-xs font-semibold">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
        ...
        <div className="relative w-full lg:w-64">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-2 bg-slate-50 hover:bg-white focus:bg-white border border-slate-200 focus:border-sky-500 focus:ring-2 focus:ring-sky-500/15 rounded-xl text-xs text-slate-900 placeholder:text-slate-400 focus:outline-none transition-all"
          />
        </div>
      </div>
        ...
        {loading ? (
          ...
          filtered.map((t) => {
            ...
            return (
              <div
                key={t.id}
                className="bg-white rounded-xl border border-slate-200 shadow-sm hover:border-slate-300 transition-colors flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4"
              >
                  ...
                  <div className="flex items-center gap-2">
                    {t.statusPembayaran !== "lunas" && t.statusPembayaran !== "refund" && (
                      <button
                        ...
                        className="px-3 py-1.5 bg-sky-50 hover:bg-sky-100 text-sky-700 text-xs font-semibold rounded-xl border border-sky-200 transition-colors inline-flex items-center gap-1 cursor-pointer disabled:opacity-50"
                      >
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 text-xs font-semibold rounded-xl shadow-sm transition-colors inline-flex items-center gap-1 cursor-pointer"
                    >
                    ...
                    {canPay(t) && (
                      <Link
                        ...
                        className="px-3.5 py-1.5 bg-sky-600 hover:bg-sky-500 active:bg-sky-700 text-white text-xs font-bold rounded-xl shadow-sm shadow-sky-600/25 transition-colors inline-flex items-center gap-1.5 cursor-pointer"
                      >
          ...
          <div className="p-16 text-center max-w-md mx-auto bg-white rounded-2xl border border-slate-200 shadow-sm space-y-3">
      ...
      {selected && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-xs">
          <div className="bg-white rounded-2xl max-w-lg w-full p-6 space-y-5 border border-slate-200 shadow-2xl relative my-8 animate-in fade-in zoom-in-95">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3.5">
              ...
              <button type="button" onClick={() => setSelected(null)} className="text-slate-400 hover:text-slate-600 p-1.5 rounded-lg hover:bg-slate-100 cursor-pointer">
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <div className="space-y-4 text-xs">
              ...
              {selected.statusPembayaran !== "lunas" && (
                <button
                  ...
                  className="w-full py-2.5 px-4 border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 text-xs font-semibold rounded-xl shadow-sm transition-colors flex items-center justify-center gap-1.5 cursor-pointer disabled:opacity-50"
                >
              ...
              {canPay(selected) && (
                <Link
                  ...
                  className="w-full py-2.5 px-4 bg-sky-600 hover:bg-sky-500 active:bg-sky-700 text-white text-xs font-bold rounded-xl shadow-sm shadow-sky-600/25 transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
                >
                  <CreditCard className="w-3.5 h-3.5" />
