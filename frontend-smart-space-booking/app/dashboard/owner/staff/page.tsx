                  ...
                  <tr key={st.id} className="hover:bg-slate-50/60 transition-colors">
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <p className="font-semibold text-slate-900">{st.staff?.namaStaff || "Staff Operasional"}</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs">
          <div className="bg-white rounded-xl max-w-sm w-full p-6 text-center space-y-4 border border-slate-200 shadow-xl">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-500">
                Apakah Anda yakin ingin menghapus <strong>{deleteTarget.staff?.namaStaff || deleteTarget.username}</strong>?
              </p>
            </div>
            <div className="grid grid-cols-2 gap-2 pt-2">
              <button
