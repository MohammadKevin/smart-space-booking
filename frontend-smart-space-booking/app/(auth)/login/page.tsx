  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center py-10 px-4 sm:px-6 bg-[#FAFCFF] text-slate-900 relative selection:bg-[#006370] selection:text-white">
      ...
      <div className="w-full max-w-[480px] bg-white rounded-xs border border-slate-100 shadow-xl shadow-slate-200/60 p-7 sm:p-9 transition-all">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-xs sm:text-[13px] text-slate-500 mt-1.5 leading-relaxed">
            Masuk untuk mengakses kunci digital, reservasi ruangan, dan transaksi Anda.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="p-3 rounded-xs bg-[#F0F9FF] border border-[#E0F2FE] flex items-start gap-2.5 text-xs text-slate-600">
            ...
            <span className="text-[11px] leading-relaxed">
              <strong className="text-slate-800">Sistem auto-routing:</strong> Mendeteksi otomatis hak akses Member, Pengelola Ruangan, atau Super Admin saat masuk.
            </span>
          </div>
      ...
      <div className="mt-8 flex items-center justify-center gap-4 text-xs text-slate-400">
        <Link href="/privacy" className="hover:text-slate-600">Kebijakan Privasi</Link>
        <span>&bull;</span>
        <Link href="/terms" className="hover:text-slate-600">Syarat &amp; Ketentuan</Link>
        <span>&bull;</span>
        <Link href="/support" className="hover:text-slate-600">Bantuan</Link>
      </div>
